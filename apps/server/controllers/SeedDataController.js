...
const towns = require("../staticData/towns");
const mrts = require("../staticData/mrts");
const userListingTags = require("../staticData/userListingTags");
const roomListingTags = require("../staticData/roomListingTags");
...
//       age: randomAge18To65(18, 65),
//       gender: "male",
//       occupation: faker.name.jobTitle(),
//       mbti: mbti[random(mbti)],
//       interests: [interests[random(interests)], interests[random(interests)]],
//       town: towns[random(towns)],
//       mrt: mrts[random(mrts)],
...
//         userListingTags[random(userListingTags)],
//       ],
//       description: faker.lorem.lines(7),
